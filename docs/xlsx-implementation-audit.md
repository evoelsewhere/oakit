...
| Typed edits, R1, and R2                               | Missing  | Typed operation discriminants and an honest `unsupported` capability surface exist; empty batches validate exactly.                                                                                                                                                                                                                                                                                                                       | Atomic replay, `ifMatch`, impact closure, deterministic allocation, part dispositions, output reopen, and independent semantic verification are not yet implemented.                                                                        |
