...
| Reader range/visual/analytical features               | Partial  | Worksheet and table-owned auto-filters preserve value/date/custom/dynamic/top/color/icon rules, custom lists, and authored sort state without applying filtering. SpreadsheetML tables resolve owner-scoped Strict/Transitional relationships and expose typed table/column metadata. Data validations preserve exhaustive type/operator/error/IME semantics, booleans, prompts/errors, formula1/2, multi-ranges, container settings, and selection relation. All three domains enforce workbook-wide rule and exact range/text/formula/grid/work limits, emit portable JSON, and have byte-identical JSON-cloned all-copy R0 fixtures. Public valid/invalid/Strict/selection/ownership/boundary tests pass; current module/worksheet/parser mutation evidence is 100% with zero survivor, no-coverage, or timeout.                                                                                                         | Conditional formatting, comments, print/protection, drawings/images/charts/sparklines, pivots/caches/slicers/timelines, known extensions, producer corpus, and portable rendering follow the remaining vertical-slice path.                                                                             |
