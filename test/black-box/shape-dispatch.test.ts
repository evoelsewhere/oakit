...
describe('PowerPoint shape dispatch through the public API', () => {
  it('resolves authored, indexed, inherited, and connector shape semantics exactly', async () => {
        ...
        <p:sld xmlns:p="${PRESENTATION_NS}" xmlns:a="${DRAWING_NS}">
          <p:cSld><p:spTree>
            ...
            <p:sp>
              ...
              <p:txBody><a:bodyPr vert="eaVert" wrap="none" lIns="914400" tIns="457200" rIns="1828800" bIns="228600"/><a:lstStyle/><a:p><a:r><a:t>Authored text</a:t></a:r></a:p></p:txBody>
            </p:sp>
            <p:sp>
    ...
    expect(adjustedShape).toMatchObject({
      ...
      name: '',
      rotate: 90,
      shadow: { blur: 2, color: '#445566', h: 1, v: 0 },
      headEnd: { length: 'lg', type: 'triangle', width: 'sm' },
      tailEnd: { length: 'sm', type: 'oval', width: 'med' },
      top: 0,
      type: 'shape',
      width: 72,
    });
    ...
    expect(authoredTextBox).toMatchObject({
      ...
      isVertical: true,
      rotate: 180,
      textInset: { b: 18, l: 72, r: 144, t: 36 },
      top: 36,
      type: 'text',
      width: 72,
      wrap: false,
