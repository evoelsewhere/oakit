...
export type BaseElement =
  Shape | Text | Image | Table | Chart | Video | Audio | Diagram | Math;
...
export type PptxInput = ArrayBuffer | Uint8Array | Blob;

export type PptxParseOptions = Options;
export type PptxElement = Element;
export type PptxSlide = Slide;
